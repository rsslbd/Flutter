...
class RegistrationForm extends StatefulWidget {
  ...
  final PostModel1? pModel;
  RegistrationForm({this.pModel});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child:widget.pModel==null? SignUpForm():SignUpForm(pModel: widget.pModel,),
      ),
    );
  }
}
...
void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> onPressedSubmit() async {
      ...
      // }
      PostModel1 pm= new PostModel1();
        pm.title= _name;
        pm.body= _password;
        if(widget.pModel!=null){
          pm.id = _id;
        }
       await ApiService().createPosts(pm);
    }
